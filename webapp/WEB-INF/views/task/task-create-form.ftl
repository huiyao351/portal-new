<!-- 新建任务窗体 -->
<div id="taskModal" class="modal hide fade panel NewWorkflowForms col-12  border-all draggable" style="width:300px;" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
  <h4 class="advancedSearchLab"><i class="icon-file-alt icon-large"></i> 新建任务  <a href="#" class="icon-remove close1" data-dismiss="modal" aria-hidden="true" value="取消" ></a></h4>
    <form method="post" class="form form-horizontal" id="createTaskForm">
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label  col-2">创建日期：</label>
            <div class="formControls  col-4">
        ...
        <div class="row cl" style="text-align:center;">
            <button class="btn btn-secondary size-M" type="button" id="createTaskBtn">
                <i class="icon-save icon-large"></i> 创 建
            </button>
        </div>

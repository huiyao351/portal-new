<style>
    ...
    .col-1-yc{width:13.33333%}
    .col-11-yc{width:86.66667%}
</style>

<!-- 新建任务 -->
<div class="row cl pl-5" id="NewTask" style="background-color:#fff;">
    <div class="col-1-yc" style="padding:10px 0px 0px 0px;">
        <h3 class="NewTaskLab-yc">新建任务:</h3>
        <img src="${base}/static/images/pic_01.png" alt="" width="100%" />
    </div>
    <div class="col-11-yc" style="padding-bottom: 6px;">
                        ...
                        <#if businessGroupItem.workflowDefineMap??>
                            <#list businessGroupItem.workflowDefineMap?keys as businessItem>
                                <div class="row border-bottom-grey businessWd">
                                    <a href="javascript:void(0)" title="${businessItem?split("@")[0]}" class="col-1" style="padding: 10px 2px 10px 2px;text-align:right;font-size:14px;font-weight: bold;" onclick="turnBusinessTab('<#if businessItem?index_of("@")!=-1>${businessItem?split("@")[1]}</#if>');">
